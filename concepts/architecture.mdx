...
To maintain security, the browser does not communicate directly with the database (Core) or the AI brain (AllKnower). The Portal acts as a BFF (Backend-for-Frontend) proxy.
