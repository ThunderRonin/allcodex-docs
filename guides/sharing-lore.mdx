...
description: "Publish read-only player-facing wikis from your grimoire using share roots, alias slugs, basic auth, and the Portal public site or Core share endpoint."
---
