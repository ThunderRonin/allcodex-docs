...
description: "Monitor OpenRouter token usage, daily burn rate, and per-task costs in the Portal observability dashboard, and enforce budgets with hard daily limits."
---
