...
description: "Reference for AllCodex environment variables across Core, AllKnower, and Portal, covering ports, data directories, OpenRouter keys, and model selection."
---
