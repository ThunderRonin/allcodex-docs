...
description: "Keep self-hosted AllCodex updated by pulling new Docker images, recreating containers, and migrating SQLite, vector index, and PostgreSQL data safely."
---
