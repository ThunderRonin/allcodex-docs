...
description: "Self-hosting requirements for AllCodex including CPU, RAM, disk, OpenRouter keys, port allocations across services, and persistent data directory layouts."
---
