...
description: "Developer guide to the AllCodex monorepo: submodule layout, TypeScript and Bun conventions, testing with Vitest and Playwright, and PR workflow."
---
