...
description: "Schema reference covering the 21 lore types, their database template IDs, promoted attributes, and AllKnower Zod extraction fields used during parsing."
---
