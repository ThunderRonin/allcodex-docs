...
description: "Reference for the AllCodex Portal Next.js API proxy routes, covering credential flow, ETAPI forwarding, AllKnower endpoints, and zero-login provisioning."
---
